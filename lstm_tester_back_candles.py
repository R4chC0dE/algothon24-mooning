...
if __name__ == "__main__":
    ...
    for backcandle in back_candles_list:
        ...
        for i in range(50):
            ...
            residuals = y_test_normalised - y_pred_normalised
            n = len(y_test)
            sigma2 = np.var(residuals)

            k = BACK_CANDLES + len(features)
            # log likelihood           
            ...
            if counter % 3 == 0 and counter != 0:
                file.write("\n")
            file.write(f"Stock {i} Normalised RMSE score: {rmse}\tAIC: {aic}\tBIC: {bic}\n")
            # counter += 1
        ...
        file.write(f"Average AIC: {avg_aic}\n")
        file.write(f"Average BIC: {avg_bic}\n")
